  ...
  return (
    <Card className="h-full w-80 shrink-0">
      <CardContent className="p-6 flex flex-col h-full">
        ...
        <p className="mt-4 text-brand-navy-900/80 flex-1">{testimonial.quote}</p>
        ...
        <div className="mt-4">
          <p className="font-semibold text-brand-navy-950">{testimonial.name}</p>
          <p className="text-sm text-brand-navy-900/60">{testimonial.role}</p>
        </div>
      </CardContent>
    </Card>
  );
...
export default function TestimonialsSection() {
  return (
    <section className="py-20 bg-brand-cream-50 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-brand-navy-950">
        ...
        {testimonials.length > 4 ? (
          <div className="relative -mx-4">
            ...
            <div className="pointer-events-none absolute inset-y-0 left-0 w-16 bg-linear-to-r from-brand-cream-50 to-transparent sm:w-32" />
            <div className="pointer-events-none absolute inset-y-0 right-0 w-16 bg-linear-to-l from-brand-cream-50 to-transparent sm:w-32" />
          </div>
        ) : (
