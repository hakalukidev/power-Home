        ...
        <div className="grid items-start gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 flex items-center gap-4 border-t border-brand-navy-950/10 pt-6 dark:border-white/10">
              ...
              />
              <div>
                <p className="font-bold text-brand-navy-950 dark:text-white">Md. Rezwan Ahmad</p>
                <p className="text-sm text-brand-navy-900/60 dark:text-brand-cream-50/60">Managing Director, Power International BD</p>
              </div>
            </div>
          </div>

          <div className="rounded-2xl border border-brand-navy-950/10 bg-white p-6 sm:p-8 dark:border-white/10 dark:bg-brand-navy-900">
            <h3 className="text-lg font-bold text-brand-navy-950 dark:text-white">Where to find us</h3>
            <ul className="mt-4 space-y-4">
              {depots.map((d) => (
                <li key={d.label} className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-brand-navy-950 dark:text-white">{d.label}</p>
                    <p className="text-sm text-brand-navy-900/70 dark:text-brand-cream-50/70">{d.value}</p>
                  </div>
                </li>
              ))}
            </ul>
